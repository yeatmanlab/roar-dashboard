...
async function runInstructionSequence(audioMapping, imageRow) {
    ...
    document.querySelector(".instruction-text").innerHTML =
        audioMapping.header.text1 || "";

    // this will be hidden, add it now so that content doesn't shift up  
    document.getElementById("text-below").innerHTML =
        audioMapping.footer.text || "";
    ...
    document.querySelector(".instruction-text").innerHTML =
        audioMapping.header.text2 || "";

    imageRow.querySelectorAll(".hidden-choice")
