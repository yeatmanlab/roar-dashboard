/**
 * @fileoverview
 * This module provides utilities for facial landmark detection, eye tracking, and geometric calculations.
 * It includes functions for processing FaceMesh results, drawing face contours, calculating head metrics,
 * and preprocessing image data for machine learning models. The module also contains constants for
 * facial landmark indices and default configurations for device and participant settings.
 *
 * Key features:
 * - FaceMesh landmark processing
 * - Eye tracking initialization and visualization
 * - Image preprocessing for ML models
 * - Geometric calculations (e.g., polygon area, centroids)
 * - Utilities for comparing face shapes and positions
 *
...
/**
 * Landmark indices defining the face oval in FaceMesh.
 * @constant {Array<Array<number>>}
 */
...
/**
 * Default device configuration for screen and webcam parameters.
 * @constant {Object}
 */
...
/**
 * Default participant configuration containing head and iris measurements.
 * @constant {Object}
 */
...
/**
 * Processes the results from the FaceMesh model.
 * Extracts iris, eye, and head coordinates and renders face outlines on a canvas.
 *
 * @function onResultsFaceMesh
 * @param {Object} results - The results object from FaceMesh.
 */
...
/**
 * Processes iris points from FaceMesh results.
 *
 * @param {Array<Array<number>>} irisPoints - The array of iris point indices.
 * @param {Array<Object>} landmarks - The FaceMesh landmarks.
 * @param {number} width - The width of the image.
 * @param {Function} callback - The callback function to process each iris point.
 */
...
/**
 * Draws a contour on a canvas.
 *
 * @param {Array<Array<number>>} points - The contour points.
...
/**
 * Draws an oval representing the face outline on the canvas.
 *
 * @param {Array} ovalIndices - Indices of the face oval landmarks.
 * @param {Array} landmarks - Array of facial landmarks.
 * @param {CanvasRenderingContext2D} ctx - The canvas rendering context.
 * @param {number} width - Width of the canvas.
 * @param {number} height - Height of the canvas.
 * @param {Array} coordinates - Array to store the landmark coordinates.
 * @returns {Array} The path of the drawn face oval.
 */
...
/**
 * Calculates depth using focal length and image dimensions.
 *
 * @param {number} imageWidth - The width of the image.
 * @param {number} imageHeight - The height of the image.
 * @param {number} dX - Displacement in x-direction.
 * @param {number} dWidth - Width displacement.
...
/**
 * Calculates head metrics such as width, height, and center.
 *
 * @param {Array<Array<number>>} headCoor - Array of head landmark coordinates.
 * @returns {Object} An object containing head width, height, and center coordinates.
 */
...
/**
 * Initializes eye tracking elements.
 *
 * @param {boolean} [showEyes=false] - Whether to show eye overlays.
...
/**
 * Converts feature coordinates to YOLO format.
 *
 * @param {Array<Array<number>>} feature - The feature points.
 * @param {number} w - Image width.
 * @param {number} h - Image height.
 * @returns {Array<number>} Converted YOLO bounding box values.
 */
 ...
 * @returns {Array<number>} The centroid coordinates [x, y].
 */
...
/**
 * Calculates the area of a polygon defined by a set of points.
 *
 * @param {Array<Array<number>>} points - An array of points representing the polygon vertices, where each point is an array of two numbers [x, y].
...
/**
 * Checks if the area of path2 is within 82-117% of path1's area.
 *
 * @param {Array<Array<number>>} path1 - First polygon path.
 * @param {Array<Array<number>>} path2 - Second polygon path.
 * @returns {boolean} Whether path2's area is within the range of path1's area.
 */
export function isAreaWithinRange(path1, path2) {
  ...
  return path2Area >= 0.82 * path1Area && path2Area <= 1.17 * path1Area;
}

/**
 * Checks if the centroid of path2 is inside path1.
 *
 * @param {Array<Array<number>>} path1 - First polygon path.
 * @param {Array<Array<number>>} path2 - Second polygon path.
 * @returns {boolean} Whether the centroid of path2 is inside path1.
 */
 ...
 *
 * @param {Array<number>} point - The point to check, represented as an array of two numbers [x, y].
 * @param {Array<Array<number>>} polygon - An array of points representing the polygon vertices, where each point is an array of two numbers [x, y].
