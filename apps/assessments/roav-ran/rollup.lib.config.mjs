...
// roav-ran diverges from the standard single-file lib template: the gaze-estimation
...
export default defineConfig({
  ...
  plugins: [
    ...
    // standalone build); consumers get styles automatically when importing the package.
    postcss({
      inject: true,
      minimize: true,
    }),
