  ...
  let stim = {
    ...
    stimulus: () => {
      ...
      return `
          ...
          <img id="replay" draggable="false" src="${
        ...
        <div class="giveN-container">
          <div class="source-container" id="source-container">
            ...
            } alt="Image 1" draggable="false" style="top: ${
              sourcePositions[0][0]
            }; left: ${sourcePositions[0][1]}">
            <img class="source" id="apple2" src=${
              mediaAssets.images.apple
            } alt="Image 2" draggable="true" style="top: ${
              sourcePositions[1][0]
            }; left: ${sourcePositions[1][1]}">
            <img class="source" id="apple3" src=${
              mediaAssets.images.apple
            } alt="Image 3" draggable="true" style="top: ${
              sourcePositions[2][0]
            }; left: ${sourcePositions[2][1]}">
            <img class="source" id="apple4" src=${
              mediaAssets.images.apple
            } alt="Image 4" draggable="true" style="top: ${
              sourcePositions[3][0]
            }; left: ${sourcePositions[3][1]}">
            <img class="source" id="apple5" src=${
              mediaAssets.images.apple
            } alt="Image 5" draggable="true" style="top: ${
              sourcePositions[4][0]
            }; left: ${sourcePositions[4][1]}">
            <img class="source" id="apple6" src=${
              mediaAssets.images.apple
            } alt="Image 6" draggable="true" style="top: ${
              sourcePositions[5][0]
            }; left: ${sourcePositions[5][1]}">
            <img class="source" id="apple7" src=${
              mediaAssets.images.apple
            } alt="Image 7" draggable="true" style="top: ${
              sourcePositions[6][0]
            }; left: ${sourcePositions[6][1]}">
            <img class="source" id="apple8" src=${
              mediaAssets.images.apple
            } alt="Image 8" draggable="true" style="top: ${
              sourcePositions[7][0]
            }; left: ${sourcePositions[7][1]}">
            <img class="source" id="apple9" src=${
              mediaAssets.images.apple
            } alt="Image 9" draggable="true" style="top: ${
              sourcePositions[8][0]
            }; left: ${sourcePositions[8][1]}">
            <img class="source" id="apple10" src=${
              mediaAssets.images.apple
            } alt="Image 10" draggable="true" style="top: ${
              sourcePositions[9][0]
            }; left: ${sourcePositions[9][1]}">   
          </div>
    ...
    on_finish: (data) => {
      ...
      let correct =
        dropCount === parseInt(stimulus.target[0]) &&
