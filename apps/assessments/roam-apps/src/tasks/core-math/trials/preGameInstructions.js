      ...
      return `
        <div class="jspsych-content-modified">
          ...
          <div class="row">
                ...
                <div style="overflow: hidden;">
                  <canvas id="canvas-timer" width="${diameter}" height="${diameter}" class="canvas-timer-instr"></canvas>
                  <img class="icon" draggable="false" src="${mediaAssets.images.iconSpeaker}" alt="replay"/>
                </div>
                  <div class="item-stimulus" style="font-size: 2rem; margin-top: 5vh">${i18next.t(
                    'terms.mathProblem',
                  )}</div>
    ...
    return `
        <div class="jspsych-content-modified">
            ...
            <p class="instructions-text">${i18next.t(
              'instructions.core-math.text10-' + store.session.get('config').labId,
            )}</p>
            <div class="row">
            <div class="single-box">
                <img src="${mediaAssets.images.paperAndPencil}" alt="arrow keys">
            </div>
            </div>
        </div>
        `;
              ...
              <div class="speechbubble">
                <div class="text-image">
                  <div>
                    ...
                    <p class="text"> ${i18next.t('instructions.core-math.text11')} </p>
                    <p class="text"> ${i18next.t('instructions.core-math.text13')} </p>
                  </div>
      ...
      return `
         <div class = "jspsych-content-modified">
            ...
            <div class="tiger-gif-container">
              <div class="speechbubble">
                <h1 class="header">${i18next.t('postPractice.text5')} </h1>
                <p class="text"> ${i18next.t('instructions.core-math.text12')} </p>
                <p class="text"> ${i18next.t('instructions.core-math.text13')} </p>
              </div>
