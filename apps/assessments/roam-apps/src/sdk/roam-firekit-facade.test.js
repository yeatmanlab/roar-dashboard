...
describe('wireScoreAdapter', () => {
  ...
  describe('_accumulateRawScore / _getRawScores', () => {
    ...
    test('collapses `${stage}_response` variants into their base scoring bucket', () => {
      facade._accumulateRawScore('geometry', 'practice_response', 1);
      facade._accumulateRawScore('geometry', 'practice', 0);
      facade._accumulateRawScore('geometry', 'test_response', 1);
      ...
      expect(raw.geometry).not.toHaveProperty('practice_response');
      expect(raw.geometry).not.toHaveProperty('test_response');
    });
