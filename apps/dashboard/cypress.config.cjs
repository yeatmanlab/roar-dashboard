...
module.exports = defineConfig({
  ...
  env: {
    ...
    testAdministrationIdLongitudinal: 'K8UaI8p79Dntj5Z2CJk8',
    testDistrictIdLongitudinal: 'qoW9OEPcV50rIA2IcqbV',
    testUserIdLongitudinal: 'yXuZ8S0En1UsOE4C0uh6wUlQ5Wt1',
