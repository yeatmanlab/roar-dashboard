<template>
  ...
  <template v-else>
    <div class="relative py-4">
      <div class="flex flex-wrap gap-1 justify-between pt-4 w-full align-items-center">
        <div class="flex flex-row flex-wrap gap-2 pb-2" aria-label="Filter Options">
          ...
          <PvFloatLabel>
            ...
            />
            <label for="data-table__select-columns">Show/Hide Columns</label>
          </PvFloatLabel>

          <PvFloatLabel>
            <PvMultiSelect
              id="data-table__freeze-columns"
            ...
            />
            <label for="data-table__freeze-columns">Freeze Columns</label>
          </PvFloatLabel>
          ...
          <PvButton
            ...
            text
            :label="rowViewMode"
            class="border-none text-primary surface-ground border-round hover:bg-gray-300"
            @click="toggleView"
          />
        </div>
...
import { progressTags, replaceScoreRange } from '@/helpers/reports';
