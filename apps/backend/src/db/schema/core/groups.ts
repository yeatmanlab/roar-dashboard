 ...
 * Groups Table
 *
 * Stores information about groups in the system. Groups are standalone flat entities
 * with no hierarchy. Commonly, groups are cohorts, communities, or businesses.
 *
