...
ALTER TABLE "app"."run_trials" ADD CONSTRAINT "run_trials_run_id_runs_id_fk" FOREIGN KEY ("run_id") REFERENCES "app"."runs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "run_trials_run_id_idx" ON "app"."run_trials" USING btree ("run_id");--> statement-breakpoint
CREATE INDEX "run_trials_run_trial_idx" ON "app"."run_trials" USING btree ("run_id","trial_index");
--> statement-breakpoint
