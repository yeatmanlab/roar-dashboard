...
ALTER TABLE "app"."orgs" ADD CONSTRAINT "orgs_parent_org_id_orgs_id_fk" FOREIGN KEY ("parent_org_id") REFERENCES "app"."orgs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "orgs_type_idx" ON "app"."orgs" USING btree ("org_type");--> statement-breakpoint
