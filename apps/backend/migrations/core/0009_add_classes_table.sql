...
ALTER TABLE "app"."classes" ADD CONSTRAINT "classes_school_id_orgs_id_fk" FOREIGN KEY ("school_id") REFERENCES "app"."orgs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."classes" ADD CONSTRAINT "classes_district_id_orgs_id_fk" FOREIGN KEY ("district_id") REFERENCES "app"."orgs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."classes" ADD CONSTRAINT "classes_course_id_courses_id_fk" FOREIGN KEY ("course_id") REFERENCES "app"."courses"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "classes_district_idx" ON "app"."classes" USING btree ("district_id");--> statement-breakpoint
