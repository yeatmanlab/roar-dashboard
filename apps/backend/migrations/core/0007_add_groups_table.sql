CREATE TABLE "app"."groups" (
	...
	CONSTRAINT "orgs_abbreviation_format" CHECK ("app"."groups"."abbreviation" ~ '^[A-Za-z0-9]+$')
);
--> statement-breakpoint
ALTER TABLE "app"."groups" ADD CONSTRAINT "groups_parent_group_id_groups_id_fk" FOREIGN KEY ("parent_group_id") REFERENCES "app"."groups"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
