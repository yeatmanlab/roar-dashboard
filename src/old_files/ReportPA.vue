...
const stackedSkillByGradePA = {
  ...
  encoding: {
    ...
    color: {
      ...
      type: 'nominal',
      scale: {
        domain: ['No Mastery', 'Some Mastery', 'Beginning to Exhibit Full Mastery', 'Full Mastery'],
...
const normedPercentileDistribution1to4PA = {
  ...
  transform: [
    ...
    {
      calculate:
        "datum.percentileRankCTOPP <= 15? 'Extra Support Needed': datum.percentileRankCTOPP <=30? 'Some Support Needed': 'Average or Above Average' ",
...
const stackedSupportByGradePA = {
  ...
  transform: [
    ...
    {
      calculate: '(datum.grade >=5)? datum.SupportGrade5to12 :datum.SupportGrade1to4 ',
      as: 'Support',
    },
    {
