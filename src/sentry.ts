...
export function initSentry(app: App): void {
  ...
  if (isLevante) {
    ...
    tracePropagationTargets = ['https://hs-levante-admin-prod.web.app/**/*', 'https://hs-levante-admin-dev.web.app/**/*', regex.toString()];
  } else {
    ...
    tracePropagationTargets = ['localhost:5173', 'https://roar.education/**/*', regex.toString()];
  }
