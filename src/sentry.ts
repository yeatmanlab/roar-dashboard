...
export function initSentry(app: App) {
  ...
  if (isLevante) {
    ...
    dsn =
      "https://f15e3ff866394e93e00514b42113d03d@o4505913837420544.ingest.us.sentry.io/4506820782129152";
  ...
  Sentry.init({
    ...
    integrations: [
      ...
      Sentry.feedbackIntegration({
        ...
        colorScheme: "light",
        formTitle:
          languageOptions[language]?.translations?.sentryForm?.formTitle ||
          "Report a bug",
        buttonLabel:
          languageOptions[language]?.translations?.sentryForm?.buttonLabel ||
          "Submit",
        cancelButtonLabel:
          languageOptions[language]?.translations?.sentryForm
        ...
        messageLabel:
          languageOptions[language]?.translations?.sentryForm?.messageLabel ||
          "Message",
        messagePlaceholder:
          languageOptions[language]?.translations?.sentryForm
