...
const routes = [
  ...
  {
    path: '/launch/:participantId/game/swr-es',
    name: 'Launch SWR-ES',
    component: () => import('../components/tasks/TaskSWR.vue'),
    props: { taskId: 'swr-es', language: 'es' },
    meta: { pageTitle: 'SWR (ES)' },
  ...
  {
    path: '/launch/:participantId/game/pa',
    name: 'Launch PA',
    component: () => import('../components/tasks/TaskPA.vue'),
    props: { taskId: 'pa', language: 'en' },
    meta: { pageTitle: 'PA' },
  ...
  {
    path: '/launch/:participantId/game/pa-es',
    name: 'Launch PA-ES',
    component: () => import('../components/tasks/TaskPA.vue'),
    props: { taskId: 'pa-es', language: 'es' },
    meta: { pageTitle: 'PA-ES' },
  ...
  {
    path: '/launch/:participantId/game/sre',
    name: 'Launch SRE',
    component: () => import('../components/tasks/TaskSRE.vue'),
    props: { taskId: 'sre', language: 'en' },
    meta: { pageTitle: 'SRE' },
  ...
  {
    path: '/launch/:participantId/game/sre-es',
    name: 'Launch SRE-ES',
    component: () => import('../components/tasks/TaskSRE.vue'),
    props: { taskId: 'sre-es', language: 'es' },
    meta: { pageTitle: 'SRE-ES' },
  ...
  {
    path: '/launch/:participantId/game/letter',
    name: 'Launch Letter',
    component: () => import('../components/tasks/TaskLetter.vue'),
    props: { taskId: 'letter', language: 'en' },
    meta: { pageTitle: 'Letter' },
  ...
  {
    path: '/launch/:participantId/game/letter-es',
  ...
  {
    path: '/launch/:participantId/game/letter-en-ca',
  ...
  {
    path: '/launch/:participantId/game/phonics',
    name: 'Launch Phonics',
    component: () => import('../components/tasks/TaskLetter.vue'),
    props: { taskId: 'phonics', language: 'en' },
    meta: { pageTitle: 'Phonics' },
  ...
  {
    path: '/launch/:participantId/game/multichoice',
  ...
  {
    path: '/launch/:participantId/game/morphology',
  ...
  {
    path: '/launch/:participantId/game/fluency-calf-es',
