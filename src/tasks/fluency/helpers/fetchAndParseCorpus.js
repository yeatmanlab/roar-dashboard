...
export const fetchAndParseCorpusFluency = async (task, assets) => {
      ...
      fluencyArf: {
        order: {
          block0:
            ...
            lng +
            `/shared/corpora/arf/items-order.csv`,
        },
        stimulus:
          `https://storage.googleapis.com/roam-apps/` +
          lng +
          `/shared/corpora/arf/items-all-cat.csv`,
        practice:
          `https://storage.googleapis.com/roam-apps/` +
          lng +
          `/shared/corpora/arf/items-practice-cat.csv`,
      },
      fluencyCalf: {
        order: {
          block0:
            `https://storage.googleapis.com/roam-apps/` +
            lng +
            `/shared/corpora/calf/items-order-phase1.csv`,
          block1:
            `https://storage.googleapis.com/roam-apps/` +
            lng +
            `/shared/corpora/calf/items-order-phase2.csv`,
          block2:
            `https://storage.googleapis.com/roam-apps/` +
            lng +
            `/shared/corpora/calf/items-order-phase3.csv`,
        },
        stimulus:
          `https://storage.googleapis.com/roam-apps/` +
          lng +
          `/shared/corpora/calf/items-all-cat.csv`,
        practice:
          `https://storage.googleapis.com/roam-apps/` +
          lng +
          `/shared/corpora/calf/items-practice-cat.csv`,
      },
    };
  } else {
    corpusLocation = {
      fluencyArf: {
        ...
        practice:
          `https://storage.googleapis.com/roam-apps/` +
          lng +
          `/shared/corpora/arf/items-practice.csv`,
      },
      fluencyCalf: {
        order: {
          block0:
        ...
        practice:
          `https://storage.googleapis.com/roam-apps/` +
          lng +
          `/shared/corpora/calf/items-practice.csv`,
      },
    };
  }
  ...
  if (config.recruitment === "demo") {
    assetListDevice.push(
      responseMode + "-post-practice-2-" + taskName + "-demo.mp3",
    );
  } else if (
    config.userMode === "4andHalfMin" &&
    config.taskName === "fluency-calf"
  ) {
    assetListDevice.push(
      responseMode +
        "-post-practice-2-" +
  ...
  if (config.recruitment === "responseModality") {
    ...
    if (store.session.get("config").taskName === "fluency-arf") {
      if (rtControl[0].includes("production")) {
        assetListDevice.push(
          "responseModality-introduction-fluency-arf-production.mp3",
        );
      } else if (rtControl[0].includes("2afc")) {
        assetListDevice.push(
          "responseModality-introduction-fluency-arf-2afc.mp3",
        );
      } else {
        assetListDevice.push(
          "responseModality-introduction-fluency-arf-6afc.mp3",
        );
      }
      ...
      assetListDevice.push(
        "responseModality-postControl-" +
          taskOrder[0].replace(/\d+/g, "") +
          ".mp3",
      );
      ...
      assetListDevice.push(
        "responseModality-introduction-fluency-calf-" +
          taskOrder[0].replace(/\d+/g, "") +
          ".mp3",
      );
      assetListDevice.push("instructions-fluency-6afc.mp3");
