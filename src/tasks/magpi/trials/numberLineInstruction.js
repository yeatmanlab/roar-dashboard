    ...
    if (store.session.get("isK2")) {
      return `
       <div class = "jspsych-content-modified">
          <img src="${
            mediaAssets.images["coreMathBreakScreen3"]
              ...
              <div class="text-image">
                <div>
                  <h1 class="header">${i18next.t(
                    "magpiPilot.numberLine.transition.K2-text1",
                  )} </h1>
                  <p class="text">${i18next.t(
                    "magpiPilot.numberLine.transition.K2-text2",
                  )} </p>
                  <p class="text">${i18next.t(
                    "magpiPilot.numberLine.transition.K2-text3",
                  )} </p>
                </div>
      ...
      return `
        <div class = "jspsych-content-modified">
          ...
          <div class="tiger-gif-container">
            <div class="speechbubble">
              <h1 class="header">${i18next.t(
                "magpiPilot.numberLine.transition.text1",
              )} </h1>
              <p class="text">${i18next.t(
                "magpiPilot.numberLine.transition.text2",
              )}</p>
              <p class="text">${i18next.t(
                "magpiPilot.numberLine.transition.text3",
              )}</p>
              <p class="text">${i18next.t(
                "magpiPilot.numberLine.transition.text4",
              )}</p>
            </div>
          </div>
        </div>
...
const transitionScreen2 = {
  ...
  prompt: () => {
    if (store.session.get("isK2")) {
      let headerText = `${i18next.t(
        "magpiPilot.numberLine.transition.K2-text4",
      )}`;
      let paraText = `${i18next.t(
        "magpiPilot.numberLine.transition.K2-text5",
      )}`;
      if (store.session.get("arrayIdx") > 0) {
      ...
      return (
       ...
       <div class = "jspsych-content-modified">
        ...
        `</p>
                  <p class="text">${i18next.t(
                    "magpiPilot.numberLine.transition.text9",
                  )}</p>
                </div>
                <img class="clipart" src=${
                  mediaAssets.images.coreMathNoShadow
...
const instructionIntro1 = () => {
  let stim = {
    ...
    stimulus: () => {
      ...
      let displayText;
      if (store.session.get("blockType") === 20) {
        displayText = `<div class="number-line-item">${i18next.t(
          "magpiPilot.numberLine.text1",
          {
            number: store.session.get("blockType"),
          },
        )}<br>${i18next.t("magpiPilot.numberLine.text3")}</div>`;
      } else if (
        store.session.get("blockType") === 100 &&
        store.session.get("arrayIdx") === 0
      ) {
        displayText = `<div class="number-line-item">${i18next.t(
          "magpiPilot.numberLine.text1",
          {
...
const instructionIntro2 = () => {
  ...
  let stim = {
    ...
    on_finish: (data) => {
      ...
      let perError = _round(
        (absDifference / store.session.get("blockType")) * 100,
        2,
      );
...
const demoFrac1 = () => {
  let stim = {
    ...
    stimulus: () => {
      return (
        `<div class="number-line-item">${i18next.t(
          "magpiPilot.numberLine.text9",
        )}</div>
                <div class="number-line-container">
                    <div class="number-line-element" id="line">
                        <div class="tick left"></div>
          ...
          "magpiPilot.numberLine.text10",
          {
            ...
            interpolation: {
              escapeValue: false,
                    ...
                    <div class="number-line-item-below">${i18next.t(
                      "magpiPilot.numberLine.transition.text9",
                    )}</div>
                <div class="number-line-container">
                    <div class="number-line-element" id="line">
