  ...
  prompt: () => {
    return `<div class="tiger-gif-container">
            ...
            <h1 class="header">${i18next.t(
              "magpiPilot.symbolicComp.intro.text1",
            )} </h1>
            <p class="text"> ${i18next.t(
              "magpiPilot.symbolicComp.intro.text2",
            )} </p>
            <p class="text"> ${i18next.t(
              "magpiPilot.symbolicComp.intro.text3",
            )} </p>
            </div>
...
const postPracticeMagpi = {
  ...
  prompt: () => {
    ...
    return `<div class="tiger-gif-container">
            <div class="speechbubble">
            <h1 class="header">${i18next.t(
              "magpiPilot.symbolicComp.postPractice.text1",
            )}</h1>
            <p class="text">${i18next.t(
              "magpiPilot.symbolicComp.postPractice.text2",
            )}</p>
            <p class="text">${i18next.t(
              "magpiPilot.symbolicComp.postPractice.text3",
            )}</p>
    ...
    return (
      ...
      `</p>
        <img class="img-border" src="${
          mediaAssets.images.instructionsSymMagpi
        }" style="width: 50%;" alt="response">
        <p class="instructions-text">${i18next.t(
          "magpiPilot.symbolicComp.instructions.text2",
        )}</p>
      </div>
      `
    );
...
export const introARF = {
  ...
  prompt: () => {
    return `<div class="tiger-gif-container">
            <div class="speechbubble">
                <h1 class="header">${i18next.t(
                  "magpiPilot.symbolicComp.intro.text4",
                )} </h1>
                <p class="text">${i18next.t(
                  "magpiPilot.symbolicComp.intro.text5",
                )} </p>
                <div class="text-image">
                    ...
                    <p class="text"> ${i18next.t(
                      "magpiPilot.symbolicComp.intro.text6",
                    )}</p>
                </div>
            </div>
            <img class="roam-tiger" src=${
