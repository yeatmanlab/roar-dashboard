    ...
    html: () => {
      ...
      return (
        ...
        `<br><br>${i18next.t("instructions.core-math.text15")}
                ...
                <img src="${
                  mediaAssets.images.keyboardFraction
                }" alt="arrow keys" style="width: 30vw; padding: 2vh;">
              </div>
            </div>
          </div>
    ...
    html: () => {
      ...
      return (
        ...
        `<p class="fraction-feedback">
          ...
          <img class="go-button" id="go-button-id" src=${
            mediaAssets.images.goButtonRectangleYellow
          } alt="button"/>
          </div>`
      );
    },
...
export const fractionInstructionDesktop = (
  corpusName,
