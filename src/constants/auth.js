 ...
 */
export const AUTH_SESSION_TIMEOUT_LIMIT = import.meta.env.VITE_AUTH_SESSION_TIMEOUT_LIMIT || 15 * 60 * 1000;
export const AUTH_SESSION_TIMEOUT_COUNTDOWN_DURATION =
  import.meta.env.VITE_AUTH_SESSION_TIMEOUT_COUNTDOWN_DURATION || 60 * 1000;
