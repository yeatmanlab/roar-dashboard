<template>
  <PvPanel header="Link Users">
    ...
    <ul>
      ...
      <li>
        <b>parentId<span class="required-field">*</span></b> - The unique identifier for the parent. Start from 1.
      </li>
      <li>
        <b>teacherId<span class="required-field">*</span></b> - The unique identifier for the teacher. Start from 1.
      </li>
    ...
    <p><span class="required-field">*</span> = These fields are ONLY required for child users.</p>

    <p>
      Below is an example of what your CSV should look like. Note that you may upload a CSV with any columns you need,
      but those not required for linking will be ignored during processing.
    </p>
