 ...
 */
export const READALOUD_TEST_CONFIG_URL = (testConfigFile: string, origin: string = GCS_ORIGIN): string =>
  `${origin}/roav-readaloud/en/shared/${testConfigFile}.json`;
 ...
 */
export const READALOUD_DEVICE_CONFIG_URL = (
  deviceConfigFile: string,
  origin: string = READALOUD_DEVICE_CONFIG_ORIGIN,
): string => `${origin}/public/config/${deviceConfigFile}.json`;
