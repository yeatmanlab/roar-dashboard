...
describe('Testing synced administration: Synced Administration 4575157549', () => {
  it('Tests a synced administration', () => {
    cy.login(Cypress.env('participantUsername'), Cypress.env('participantPassword'));
    cy.visit('/', { timeout: 2 * timeout });
    cy.selectAdministration('Synced Administration 4575157549');
    testSpecs.forEach((spec) => {
      testGame(spec, 'Synced Administration 4575157549');
    });
    cy.log(`Found administration: Synced Administration 4575157549`);
  });
});
