...
describe('Testing synced administration: Synced Administration 8325119901', () => {
  it('Tests a synced administration', () => {
    cy.login(Cypress.env('participantUsername'), Cypress.env('participantPassword'));
    cy.visit('/', { timeout: 2 * timeout });
    cy.selectAdministration('Synced Administration 8325119901');
    testSpecs.forEach((spec) => {
      testGame(spec, 'Synced Administration 8325119901');
    });
    cy.log(`Found administration: Synced Administration 8325119901`);
  });
});
